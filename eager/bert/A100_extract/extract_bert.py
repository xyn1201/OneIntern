...
def extract_result(args, extract_func):
    ...
    for m_l in megatron_list:
        ...
        megatron_throughput_final_result_dict[case_header][
            "megatron_log"
        ] = "https://oneflow-test.oss-cn-beijing.aliyuncs.com/EagerTest/cloud_a100/megatron/{}".format(
...
| {case_name}   | [{libai_memory}]({libai_yaml}) MiB/[{libai_samples}]({libai_log}) samples/s                                 | {megatron_memory} MiB/[{megatron_samples}]({megatron_log}) samples/s |"""
    ...
    for l in logs_list:
        ...
        throughput_final_result_dict[case_header][
            "libai_yaml"
        ] = "https://oneflow-test.oss-cn-beijing.aliyuncs.com/EagerTest/cloud_a100/eager/{}/{}/config.yaml".format(args.oneflow_commit,
        ...
        throughput_final_result_dict[case_header][
            "libai_log"
        ] = "https://oneflow-test.oss-cn-beijing.aliyuncs.com/EagerTest/cloud_a100/eager/{}/{}".format(args.oneflow_commit,
