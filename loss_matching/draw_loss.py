...
if __name__ == "__main__":
    ...
    draw_and_save(
        {
            "title": "loss_curve",
            "save_path": add_pth(".", "loss_curve_0ccbae9_gpt2_1n8g.png"),
            "txts": [
                "gpt2_loss_0ccbae9_ampoff_shuffleoff_1n8g.txt",
                "gpt2_loss_oneflow_ampoff_shuffleoff_1n8g.txt",
            ],
            "names": [
                "gpt2_loss_0ccbae9_1n8g",
                "gpt2_loss_oneflow0.8.0_1n8g",
